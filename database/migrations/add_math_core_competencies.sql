...
-- 創建數學核心素養表
CREATE TABLE IF NOT EXISTS math_core_competencies (
  ...
  code VARCHAR(20) NOT NULL COMMENT '核心素養編碼（數-E-A1/數-J-A1/數S-U-A1）',
  general_description TEXT NOT NULL COMMENT '總綱核心素養項目說明',
  specific_description TEXT NOT NULL COMMENT '數學領域核心素養具體內涵（國民小學教育(E)/國民中學教育(J)/普通型高級中等學校教育(S-U)）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='數學核心素養（國小/國中/高中）';

SELECT '數學核心素養資料表創建成功' AS message;
