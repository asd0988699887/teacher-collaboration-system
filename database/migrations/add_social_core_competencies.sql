...
-- 創建社會科核心素養表
CREATE TABLE IF NOT EXISTS social_core_competencies (
  ...
  code VARCHAR(20) NOT NULL COMMENT '核心素養編碼（社-E-A1/社-J-A1/社-U-A1）',
  general_description TEXT NOT NULL COMMENT '總綱核心素養項目說明',
  specific_description TEXT NOT NULL COMMENT '社會領域核心素養具體內涵（國民小學教育(E)/國民中學教育(J)/高級中等學校教育(U)）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='社會科核心素養（國小/國中/高中）';

SELECT '社會科核心素養資料表創建成功' AS message;
