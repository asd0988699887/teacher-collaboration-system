...
DELETE FROM social_middle_high_contents;

INSERT INTO social_middle_high_contents (id, code, stage, subject, theme, theme_name, category, category_name, description, sort_order) VALUES
...
SELECT COUNT(*) AS mh_content_count FROM social_middle_high_contents;
