...
-- 創建英文學習表現表
CREATE TABLE IF NOT EXISTS english_learning_performances (
  id VARCHAR(36) PRIMARY KEY COMMENT '唯一識別碼',
  code VARCHAR(20) NOT NULL UNIQUE COMMENT '完整編碼 (例如: 1-II-1)',
  category INT NOT NULL COMMENT '類別 (1-9: 聽/說/讀/寫/聽說讀寫綜合應用能力/學習興趣與態度/學習方法與策略/文化理解/邏輯思考判斷與創造力)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='英文領域學習表現';

SELECT '英文學習表現資料表創建成功' AS message;
